<!-- Pendapatan -->
<v-card>
    <v-card-title><?= lang('App.income'); ?> ({{idToko.length == [] ? dataToko.length:idToko.length}} Outlet)
        <v-spacer></v-spacer>
    ...
    <v-card-text class="pt-0">
        <v-list class="pt-0">
            ...
            <v-list-item class="ms-7">
                <v-list-item-content>
                    <v-list-item-title>Pemasukan <?= lang('App.sales'); ?> (KAS)</v-list-item-title>
                </v-list-item-content>
                <v-spacer></v-spacer>
            ...
            <v-list-item class="ms-7">
                <v-list-item-content>
                    <v-list-item-title>Pemasukan <?= lang('App.sales'); ?> (BANK)</v-list-item-title>
                </v-list-item-content>
                <v-spacer></v-spacer>
                <h3 class="font-weight-regular">{{Ribuan(pemasukanPenjualanBank ?? "0")}}</h3>
            </v-list-item>
            <v-divider></v-divider>
            <v-list-item class="ms-7">
                <v-list-item-content>
                    <v-list-item-title>Penghasilan Lain (Pemasukan Lainnya &amp; Mutasi)</v-list-item-title>
                </v-list-item-content>
                <v-spacer></v-spacer>
...
<v-card>
    ...
    <v-card-text class="pt-0">
        <v-list class="pt-0">
            ...
            <v-list-item class="ms-7">
                <v-list-item-content>
                    <v-list-item-title>Pengeluaran &amp; Biaya KAS<br /><small>(Termasuk Potongan Pembulatan Kebawah)</small></v-list-item-title>
                </v-list-item-content>
                <v-spacer></v-spacer>
            ...
            <v-list-item class="ms-7">
                <v-list-item-content>
                    <v-list-item-title>Pengeluaran BANK</v-list-item-title>
                </v-list-item-content>
                <v-spacer></v-spacer>
                <h3 class="font-weight-regular">{{RibuanLocale(pengeluaranBank ?? "0")}}</h3>
            </v-list-item>
            <v-divider></v-divider>
            <v-list-item class="ms-7">
                <v-list-item-content>
...
<v-card>
    <v-card-title>
        <v-btn outlined :href="'<?= base_url('laporan/labarugi-pdf') ?>' + '?outlet=' + idToko + '&tgl_start=' + startDate + '&tgl_end=' + endDate + '&totaloutlet=' + dataToko.length" target="_blank">
