...
<body>
    <div class="container mt-5">
        ...
        <h1 style="margin-bottom: 5px;"><?= $toko['nama_toko'] ?? "Laporan Laba Rugi"; ?></h1>
        ...
        <h4>Laba Rugi <!-- (<?= date('d-m-Y', strtotime($tgl_start)); ?> - <?= date('d-m-Y', strtotime($tgl_end)); ?>) --> (<?= $outlet; ?> Outlet)</h4>
        <table class="table table-bordered" style="width: 100% !important;">
            <tbody>
                ...
                <tr>
                    <td colspan="4" style="padding-left: 40px;">Pemasukan Penjualan (KAS)</td>
                    <td><?= Ribuan($data['pemasukan_penjualan']) ?? "0"; ?></td>
                    <td></td>
                </tr>
                <tr>
                    <td colspan="4" style="padding-left: 40px;">Pemasukan Penjualan (BANK)</td>
                    <td><?= Ribuan($data['pemasukan_penjualan_bank']) ?? "0"; ?></td>
                    <td></td>
                </tr>
                <tr>
                    <td colspan="4" style="padding-left: 40px;">Penghasilan Lain (Pemasukan Lainnya &amp; Mutasi)</td>
                ...
                <tr>
                    <td colspan="4" style="padding-left: 40px;">Pengeluaran & Biaya (KAS)<br /><small>(Termasuk Potongan Pembulatan Kebawah)</small></td>
                    <td><?= Ribuan($data['pengeluaran']) ?? "0"; ?></td>
                    <td></td>
                </tr>
                <tr>
                    <td colspan="4" style="padding-left: 40px;">Pengeluaran BANK</td>
                    <td><?= Ribuan($data['pengeluaran_bank']) ?? "0"; ?></td>
                    <td></td>
                </tr>
                <tr>
