...
namespace App\Modules\StokOpname\Models;
...
class StokOpnameModel extends Model
{
    ...
    public function getStokOpname($start = false, $end = false)
    {
        $this->select("{$this->table}.*, b.kode_barang, b.nama_barang, b.barcode, l.nama as nama_user, t.nama_toko");
