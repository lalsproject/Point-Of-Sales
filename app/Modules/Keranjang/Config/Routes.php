...
$routes->group('api', ['filter' => 'jwtauth', 'namespace' => 'App\Modules\Keranjang\Controllers\Api'], function($routes){
	...
	$routes->get('keranjang/pending/get', 'KeranjangPending::index');
	$routes->get('keranjang/pending/(:segment)', 'KeranjangPending::show/$1');
	$routes->post('keranjang/pending/save', 'KeranjangPending::create');
});