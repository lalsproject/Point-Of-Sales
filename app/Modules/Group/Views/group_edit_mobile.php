                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="v-input__control">
                                        <div class="v-input__slot">
                                            <input class="v-input--selection-controls__input" type="checkbox" name="permission[]" id="saveConfig" value="saveConfig" <?php if ($permissions) { ?> <?php if (in_array('saveConfig', $permissions)) { ?> <?= "checked"; ?> <?php } ?> <?php } ?>>
                                            <label for="saveConfig"></label>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="v-input__control">
                                        <div class="v-input__slot">
                                            <input class="v-input--selection-controls__input" type="checkbox" name="permission[]" id="deleteConfig" value="deleteConfig" <?php if ($permissions) { ?> <?php if (in_array('deleteConfig', $permissions)) { ?> <?= "checked"; ?> <?php } ?> <?php } ?>>
                                            <label for="deleteConfig"></label>
                                        </div>
                                    </div>
                                </td>
                                <td>
