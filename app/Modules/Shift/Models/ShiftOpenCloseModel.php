...
class ShiftOpenCloseModel extends Model
{
    ...
    {
        $this->select("{$this->table}.*, s.nama_shift, s.jam_mulai, s.jam_selesai, l.email, l.username, l.nama, t.nama_toko");
    ...
    {
        $this->select("{$this->table}.*, s.nama_shift, s.jam_mulai, s.jam_selesai, l.email, l.username, t.nama_toko");
        $this->join("shift s", "s.id_shift = {$this->table}.id_shift");
        $this->join("login l", "l.id_login = {$this->table}.id_login");
        $this->join("toko t", "t.id_toko = {$this->table}.id_toko");
