...
class PenjualanModel extends Model
{
    ...
    {
        $this->select("{$this->table}.*, l.nama, p.id_piutang, p.sisa_piutang, p.status_piutang, k.nama as nama_kontak, k.grup, k.perusahaan, k.alamat, k.telepon, k.email, t.nama_toko");
